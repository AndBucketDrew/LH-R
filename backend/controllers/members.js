...
const getAllMembers = async (req, res, next) => {
  ...
  try {
    ...
    const membersList = await Member.find({}).populate('favorites');
...
const addFavorite = async (req, res, next) => {
  // angemeldeten Member suchen aus Token ID
  ...
  // Liste favorites den neuen Favoriten hinzufügen (nur wenn noch nicht vorhanden)
